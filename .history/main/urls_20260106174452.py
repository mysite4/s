...
urlpatterns = [
    ...
    path('appointments/delete/', views.delete_appointment, name='delete_appointment'),
    ...
    path('update-paid/', views.update_paid, name='update_paid'),
    ...
    path('services/prices/', views.price_list, name='price_list'),
]
